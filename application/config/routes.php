...
$route['recuperar'] = 'SessionController/recuperar';
...
$route['insert_diagnostico'] = 'Inicio/insertDiagnostico';

$route['insert_funcionario'] = 'Funcionario/insert';
$route['send-email'] = 'EmailController';
$route['email'] = 'EmailController/envio';
